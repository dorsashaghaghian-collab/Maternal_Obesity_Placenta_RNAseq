...
> End-to-end RNA-seq analysis of publicly available mouse placental
> transcriptomic data to identify genes and pathways associated with
> maternal obesity.

## 🔬 Research Question

Does maternal obesity alter the transcriptional landscape of the mouse placenta,
and which genes and biological pathways are most strongly affected?
...
![RNA-seq workflow](docs/figures/rnaseq_workflow.png)
...
comparing maternal obesity versus control placenta samples.

![Volcano plot](06_visualization/volcano/volcano_plot.png)
![Volcano Plot](06_visualization/Volcano_plot.png)

![MA Plot](06_visualization/MA_plot.png)
## Principal Component Analysis

PCA was used to assess sample-level transcriptional structure
and evaluate whether samples clustered according to maternal
obesity status.

![PCA](06_visualization/PCA/PCA_plot.png)
...
1. The analysis includes a relatively small number of biological
   replicates (n=5).
2. The study is based on publicly available data generated by
   another research group.
3. Differential expression findings should be validated using
   independent datasets.
4. Candidate-gene interpretation does not establish causality.
5. Additional biological and clinical metadata could improve
   interpretation of obesity-associated transcriptional changes.
